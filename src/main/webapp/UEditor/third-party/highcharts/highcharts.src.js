 ...
 * of segments in year charts, the normalizing logic was extracted in order to 
...
SVGRenderer.prototype = {
	 ...
	 * gradient configuration object. Prior to Highyear, an array was used to define
...
Axis.prototype = {
	...
	setTickPositions: function (secondPass) {
		...
		// hook for extensions, used in Highyear ordinal axes
...
Chart.prototype = {
	...
	firstRender: function () {
		...
		// those before rendering. Used in Highyear. 
...
Series.prototype = {
	...
	translate: function () {
		...
		for (i = 0; i < dataLength; i++) {
			...
			// general hook, used for Highyear compare mode
			if (hasModifyValue) {
